...
INSERT INTO `detalles` (`id`, `imagen`, `idProp`) VALUES
(1, '1.jpg', 1),
(2, '2.jpg', 1),
(3, '3.jpg', 1),
(4, '4.jpg', 1),
...
`id` int(11) NOT NULL,
  ...
  `valorMensual` varchar(100) NOT NULL,
  `direccion` varchar(255) NOT NULL,
  `acceso` varchar(100) NOT NULL,
  `piso` varchar(100) NOT NULL,
  `utilidad` varchar(255) NOT NULL,
...
INSERT INTO `propiedad` (`id`, `nombre`, `valorMensual`, `direccion`, `acceso`, `piso`, `utilidad`, `descripcion`, `imagen`) VALUES
